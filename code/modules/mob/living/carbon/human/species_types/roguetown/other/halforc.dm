...
/datum/species/halforc
	...
	specstats = list("strength" = 3, "perception" = -2, "intelligence" = -3, "constitution" = 2, "endurance" = 1, "speed" = 0, "fortune" = 0)
	specstats_f = list("strength" = 2, "perception" = -1, "intelligence" = -2, "constitution" = 1, "endurance" = 2, "speed" = 0, "fortune" = -1)
