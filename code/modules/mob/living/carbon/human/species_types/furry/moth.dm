...
/datum/species/moth
	...
	specstats = list("strength" = -1, "perception" = 1, "intelligence" = 0 "constitution" = 0, "endurance" = 1, "speed" = 0, "fortune" = 0)
	specstats_f = list("strength" = -1, "perception" = 1, "intelligence" = 0, "constitution" = 0, "endurance" = 0, "speed" = 0, "fortune" = 0)
