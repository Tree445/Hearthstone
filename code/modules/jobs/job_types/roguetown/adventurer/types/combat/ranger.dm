...
/datum/outfit/job/roguetown/adventurer/ranger/pre_equip(mob/living/carbon/human/H)
	...
	var/classes = list("Ranger","Gloom Stalker","Glade Walker") // Ranger Knight is the unique subclass. Gives you steel breastplate and a sword.
		...
		switch(H.patron.name)
			if("Dendor")
				switch(classchoice)
					if("Glade Walker")
			H.set_blindness(0)
			to_chat(H, span_warning("Gladewalkers are the militant arm of Dendor, charged with the ability to use miracles, they fight from the bushes."))
