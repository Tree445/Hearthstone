...
/datum/outfit/job/roguetown/bogguardsman/proc/assign_skills(mob/living/carbon/human/H)
	...
	H.change_stat("endurance", 1) // seven stat spread, watch get 9, royal guard get 12-13
	H.change_stat("intelligence", -2) // we dont want you being crafters and making a smith
