...
#define TRAIT_SILLYPERSON "Ignorant" //being faithless means gods won't really help you, will they
...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_SILLYPERSON = span_warning("I don't hold them in my thoughts or prayers - the Gods won't care for me, if they ever did in the first place."),
))
